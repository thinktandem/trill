 ...
 * trill.cache.set('mykey', data);
 *
 * // Get an item from the cache
 * var value = trill.cache.get('mykey');
 *
 * // Remove an item from the cache
 * trill.cache.remove('mykey');
 */
 ...
 * trill.cache.set('mykey', 'mystring');
 *
 * // Add an object to persist in the file cache
 * trill.cache.set('mykey', data, {persist: true});
 *
 * // Add an object to the cache for five seconds
 * trill.cache.set('mykey', data, {ttl: 5});
 */
 ...
 * var data = trill.cache.get('mykey');
 */
