...
// Set our maxListeners to something more reasonable for trill
 ...
 * trill.events.on('post-instantiate-app', 1, function(app) {
 *   console.log(app);
 * });
 *
 ...
 *   trill.log.info('App %s started', app.name);
 * });
 */
 ...
 * return trill.events.emit('wolf359', config);
 *
